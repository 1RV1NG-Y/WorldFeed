...
class News extends React.Component {
    ...
    async componentDidMount() {
      ...
      let res = await fetch(
        `https://newsapi.org/v2/everything?q=${this.props.newsName}&language=es&pageSize=4&apiKey=d3222134946243268fd7e02623cfb632`
      );
        ...
        return (
          ...
          <div class="max-w-sm rounded overflow-hidden shadow-lg">
            ...
            <div class="px-6 pt-4 pb-2">
              <span class="inline-block bg-gray-200 rounded-full px-3 py-1 text-sm font-semibold text-gray-700 mr-2 mb-2">#Tesla</span>
              <span class="inline-block bg-gray-200 rounded-full px-3 py-1 text-sm font-semibold text-gray-700 mr-2 mb-2">#Bitcoin</span>
              <span class="inline-block bg-gray-200 rounded-full px-3 py-1 text-sm font-semibold text-gray-700 mr-2 mb-2">#AI</span>
            </div>
            <Stock StockSymbol={this.props.simbolo} API={this.props.API}></Stock>
          </div>
